...
# Save data frames ----
write.csv(Vertebrate_data, "data/input/global_mus_scaled.csv")
write.csv(Vert_abundance, "data/input/global_rates_scaled.csv")
