...
# Get species list
mus_names <- read.csv("data/input/global_mus_scaled.csv") %>% 
...
# write.csv(habitat_df_unique, "data/input/iucn_sp_habitats_global.csv")
write.csv(habitat_df_count, "data/input/iucn_sp_habitats_count_global.csv")